    ...
    <div className="">
      <div className="bg-white p-8 rounded shadow-md w-96">
        ...
        <input
          ...
          className="w-full border text-black border-gray-300 rounded px-3 py-2 mb-4 focus:outline-none focus:border-blue-500"
        />
        <input
          type="email"
          placeholder="Email"
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded px-3 py-2 mb-4 focus:outline-none focus:border-blue-500"
        />
        <button onClick={handleLogin} className="w-full bg-gray-500 text-white py-2 rounded hover:bg-gray-600 focus:outline-none">
          Login
        </button>
      </div>
    </div>

...
const Register = () => {
    ...
    try {
      ...
      if (error.response) {
        ...
        if (error.response.status === 400) {
          // Bad Request - registration data validation failed
  ...
  return (
    <div className="">
      <div className="bg-white text-white p-8 rounded shadow-md w-96">
...
<input
  ...
  className="w-full border border-gray-300 rounded px-3 py-2 mb-4 focus:outline-none focus:border-blue-500 text-black" />
        ...
        <button onClick={handleRegister} className="w-full bg-gray-500 text-white py-2 rounded hover:bg-blue-600 focus:outline-none">
          Register
        </button>
      </div>
    </div>
